...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'posts_post', (
            ...
            ('descriptions', self.gf('django.db.models.fields.TextField')(max_length=100)),
            ('points', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2)),
        ))
